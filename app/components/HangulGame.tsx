...
const wordDatabase = [
  ...
  { word: '차', emoji: '🚗', category: '교통' },
  { word: '버스', emoji: '🚌', category: '교통' },
  { word: '택시', emoji: '🚕', category: '교통' },
  { word: '기차', emoji: '🚆', category: '교통' },
  { word: '전철', emoji: '🚇', category: '교통' },
  { word: '비행기', emoji: '✈️', category: '교통' },
  { word: '배', emoji: '🚢', category: '교통' },
  { word: '자전거', emoji: '🚲', category: '교통' },
  { word: '오토바이', emoji: '🏍️', category: '교통' },
  { word: '트럭', emoji: '🚚', category: '교통' },
  { word: '소방차', emoji: '🚒', category: '교통' },
  { word: '경찰차', emoji: '🚓', category: '교통' },
  { word: '구급차', emoji: '🚑', category: '교통' },
  { word: '헬기', emoji: '🚁', category: '교통' },
  { word: '로켓', emoji: '🚀', category: '교통' },

  { word: '의사', emoji: '👨‍⚕️', category: '직업' },
  { word: '간호사', emoji: '👩‍⚕️', category: '직업' },
  { word: '선생님', emoji: '👩‍🏫', category: '직업' },
  { word: '경찰', emoji: '👮', category: '직업' },
  { word: '소방관', emoji: '👨‍🚒', category: '직업' },
  { word: '요리사', emoji: '👨‍🍳', category: '직업' },
  { word: '농부', emoji: '👨‍🌾', category: '직업' },
  { word: '과학자', emoji: '👨‍🔬', category: '직업' },
  { word: '학생', emoji: '🧑‍🎓', category: '직업' },
  { word: '회사원', emoji: '🧑‍💼', category: '직업' },
  { word: '운동선수', emoji: '🏃', category: '직업' },
  { word: '가수', emoji: '🎤', category: '직업' },

  { word: '집', emoji: '🏠', category: '장소' },
  { word: '학교', emoji: '🏫', category: '장소' },
  { word: '병원', emoji: '🏥', category: '장소' },
  { word: '공원', emoji: '🏞️', category: '장소' },
  { word: '마트', emoji: '🏪', category: '장소' },
  { word: '시장', emoji: '🏬', category: '장소' },
  { word: '식당', emoji: '🍽️', category: '장소' },
  { word: '카페', emoji: '☕', category: '장소' },
  { word: '극장', emoji: '🎬', category: '장소' },
  { word: '도서관', emoji: '📚', category: '장소' },
  { word: '운동장', emoji: '🏟️', category: '장소' },
  { word: '바다', emoji: '🏖️', category: '장소' },
  { word: '공항', emoji: '🛫', category: '장소' },
  { word: '항구', emoji: '⚓', category: '장소' },
  { word: '산책로', emoji: '🚶', category: '장소' },


  { word: '축구', emoji: '⚽', category: '스포츠' },
  { word: '농구', emoji: '🏀', category: '스포츠' },
  { word: '야구', emoji: '⚾', category: '스포츠' },
  { word: '테니스', emoji: '🎾', category: '스포츠' },
  { word: '배구', emoji: '🏐', category: '스포츠' },
  { word: '수영', emoji: '🏊', category: '스포츠' },
  { word: '달리기', emoji: '🏃', category: '스포츠' },
  { word: '자전거', emoji: '🚴', category: '스포츠' },
  { word: '볼링', emoji: '🎳', category: '스포츠' },
  { word: '당구', emoji: '🎱', category: '스포츠' },
  { word: '스키', emoji: '🎿', category: '스포츠' },
  { word: '썰매', emoji: '🛷', category: '스포츠' },
  { word: '게임', emoji: '🎮', category: '놀이' },
  { word: '퍼즐', emoji: '🧩', category: '놀이' },
  { word: '장난감', emoji: '🧸', category: '놀이' },

  { word: '웃음', emoji: '😀', category: '표정' },
  { word: '기쁨', emoji: '😄', category: '표정' },
  { word: '슬픔', emoji: '😢', category: '표정' },
  { word: '화남', emoji: '😠', category: '표정' },
  { word: '놀람', emoji: '😲', category: '표정' },
  { word: '졸림', emoji: '😴', category: '표정' },
  { word: '아픔', emoji: '🤒', category: '표정' },
  { word: '사랑', emoji: '😍', category: '표정' },
  { word: '하트', emoji: '❤️', category: '표정' },
  { word: '웃겨', emoji: '🤣', category: '표정' },
  { word: '부끄', emoji: '😳', category: '표정' },
  { word: '무서움', emoji: '😱', category: '표정' },
  { word: '생각', emoji: '🤔', category: '표정' },
  { word: '화이팅', emoji: '💪', category: '표정' },
  { word: '엄지', emoji: '👍', category: '표정' },
